...
export default function LoginpPage() {
  const { setTokens, user, setUser } = useAuthStore();
  ...
  useEffect(() => {
    if (user) {
      router.push(redirectPath); // quay lại trang trước sau khi đăng nhập
    }
        ...
        <CardContent className="space-y-6">
          ...
          >
            <div className="space-y-4">
              ...
              <Button onClick={onFinish} type="button" className="w-full">
                Đăng nhập
              </Button>
            </div>
          </form>
