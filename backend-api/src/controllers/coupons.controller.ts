...
const getAll = async(req: Request, res: Response, next: NextFunction) => {
    ...
    sendJsonSuccess(res, coupons, httpStatus.OK.statusCode, httpStatus.OK.message)
    } catch (error) {
        next(error);
    }
}
...
const create = async(req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        sendJsonSuccess(res, coupon, httpStatus.CREATED.statusCode, httpStatus.CREATED.message)
    } catch (error) {
        next(error);
    }
}
...
const deleteById = async(req: Request, res: Response, next: NextFunction) => {
    try {
        const {id} = req.params;
        const coupon = couponsService.deleteById(id);
        sendJsonSuccess(res, coupon, httpStatus.OK.statusCode, httpStatus.OK.message);
    } catch (error) {
        next(error);
    }
